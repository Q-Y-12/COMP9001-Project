...
##Removing old test files before starting
...
##Testing if RescueMessage can be saved as one correct line.
...
##Checking the template dictionary has the expected situations and styles.
...
##Testing if generate_message_text returns one message from the correct list.
...
##Testing save_to_file and count_lines.
...
##Testing if history statistics can find the most common situation and style.
